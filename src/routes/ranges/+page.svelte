<script lang="ts">
    ...
    const fallbackRanges: Range[] = [
        { id: "1", name: "NCAE Practice v1.0", description: "Sample Linux Environment modeled after NCAE", isRunning: true },
        { id: "2", name: "NCCDC Lab", description: "Lab with 10 Windows, 10 Linux, Kubernetes, and more!", isRunning: false },
        { id: "3", name: "GOAD", description: "Game of active directory", isRunning: true },
        { id: "4", name: "C2 Practice", description: "Lab with Sliver, Havoc, Cobalt Strike, Metasploit, and Epire installed.", isRunning: false },
        { id: "5", name: "Linux basics", description: "40 Linux machines with randomized misconfigurations.", isRunning: true}
    ];
        ...
        try {
            ...
            if (result.error) {
                ...
                if (deployedRanges.length === 0) {
                    console.log('No ranges returned from API');
                }
            } else {
