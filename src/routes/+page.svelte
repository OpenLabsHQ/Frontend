  ...
  <div class="mx-auto flex h-16 max-w-screen-xl items-center justify-between px-4 sm:px-6 lg:px-8">
    ...
    <div class="hidden md:flex md:items-center md:gap-4 lg:gap-8">
      {#if $auth.isAuthenticated}
        ...
        <button on:click={handleLogout} class="text-red-400 hover:text-red-300">Logout</button>
      {:else}
        <a href="/signup" class="hover:text-gray-300">Sign Up</a>
        <a href="/login" class="hover:text-gray-300">Login</a>
      {/if}
      <a href="https://github.com/OpenLabsHQ/Setup" target="_blank" rel="noreferrer">
...
<div class="fixed inset-0 flex flex-col bg-gray-900 pt-16">
  <div class="flex-1 flex items-center justify-center">
    <div class="text-center px-4">
      <h1 class="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 bg-clip-text text-4xl font-extrabold uppercase tracking-tighter text-transparent sm:text-5xl lg:text-7xl">OpenLabs</h1>
      ...
      <div class="mt-8">
        <button 
          ...
          class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-md shadow-sm transition-colors">
  ...
  <footer class="w-full text-center py-4 bg-gray-900 text-white border-t border-gray-800">
